...
-- ADICIONE O CÓDIGO ABAIXO NO ARQUIVO /vrp/config/Vehicle.lua
function VehicleGlobal()
    return List
end

-- ADICIONE O CÓDIGO ABAIXO NO ARQUIVO /vrp/config/Item.lua
function itemList()
	return List
end
...
-- ADICIONE O CÓDIGO ABAIXO NO ARQUIVO /vrp/modules/server.lua
...
function vRP.hasPerm(user_id, cargo, hierarquia)
